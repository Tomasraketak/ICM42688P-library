/*
 * ICM42688P-Voltino Library Example: SPI FIFO Read
 * 
 * This example demonstrates how to initialize the ICM-42688-P IMU sensor over SPI,
 ...
 * - Connect the IMU to your Arduino board via SPI:
 *   - SCK, MOSI, MISO to standard SPI pins.
 *   - CS to pin 17 (adjust CS_PIN if needed).
 * - Keep the IMU stable for accurate readings.
 * 
 * Usage:
 ...
 * 
 * Note: If using a different ODR, adjust imu.setODR() accordingly. Higher ODR may require faster reading to avoid FIFO overflow.
 * 
...
void setup() {
  ...
  Serial.println("Initializing IMU (SPI)...");
